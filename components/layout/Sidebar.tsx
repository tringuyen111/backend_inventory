...
const ALL_MENU_ITEMS: MenuItem[] = [
    ...
    },
    {
        ...
        children: [
             ...
             { menu_item: 'Locations', path: '/master-data/locations', icon: 'MapPin', requiredPermission: 'LOCATION.read' },
             { menu_item: 'Products', path: '/master-data/products', icon: 'Package', requiredPermission: 'PRODUCT.read' },
             { menu_item: 'Partners', path: '/master-data/partners', icon: 'Handshake', requiredPermission: 'PARTNER.read' },
             { menu_item: 'Lots & Serials', path: '/master-data/lots', icon: 'SlidersHorizontal', requiredPermission: 'LOT.read' },
             { menu_item: 'UOMs', path: '/master-data/uoms', icon: 'Scale', requiredPermission: 'UOM.read' },
        ]
    },
    {
        menu_item: 'Settings', path: '/settings', icon: 'Settings', requiredPermission: 'SETTING.read',
        children: [
            { menu_item: 'Users', path: '/settings/users', icon: 'Users', requiredPermission: 'USER.read' },
            { menu_item: 'Roles & Permissions', path: '/settings/roles', icon: 'ShieldCheck', requiredPermission: 'ROLE.read' },
